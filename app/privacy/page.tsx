      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-text-secondary">We collect several types of information for various purposes to provide and improve our Service to you:</p>
            ...
            <p className="text-text-secondary">We use the collected data for various purposes:</p>
            <ul className="list-disc ml-6 my-4 text-text-secondary">
            ...
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">5. Service Providers</h2>
            <p className="text-text-secondary">
            ...
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">6. Children's Privacy</h2>
            <p className="text-text-secondary">
            ...
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">7. Changes to This Privacy Policy</h2>
            <p className="text-text-secondary">
