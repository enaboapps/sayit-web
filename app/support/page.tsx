  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Support</h1>
          
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Contact Us</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Have questions or need help with SayIt!? We're here to help!
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              Email: <a href="mailto:enaboapps@gmail.com" className="text-gray-700 dark:text-gray-300 hover:underline">enaboapps@gmail.com</a>
            </p>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/privacy" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
        ...
        >
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">How do I create a phrase board?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Can I use SayIt! offline?</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">How do I customize the voice settings?</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">What is included in the Pro subscription?</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">How do I cancel my subscription?</h3>
              <p className="text-gray-700 dark:text-gray-300">
