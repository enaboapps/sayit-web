...
export const initializeSettings = mutation({
  args: {
    ...
    messageCaptureMode: v.union(v.literal('disabled'), v.literal('speakOnly'), v.literal('speakAndClearOnly')),
...
export const updateSettings = mutation({
  args: {
    ...
    messageCaptureMode: v.optional(v.union(v.literal('disabled'), v.literal('speakOnly'), v.literal('speakAndClearOnly'))),
